# Description
"""
Generate data for the 201 cats database and commit data directly to PostgreSQL
"""
...
# connect to the db
con = psycopg2.connect("host = localhost dbname=201Cats user=xxxx password = xxxx")
